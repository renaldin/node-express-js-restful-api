...
import { getValidation, loginValidation, registerValidation, updateValidation } from "../validation/userValidation.js"
...
const logout = async (username) => {
    const userName = validate(getValidation, username)
    const user = await prismaClient.user.findUnique({
        where: {
            username: userName
        }
